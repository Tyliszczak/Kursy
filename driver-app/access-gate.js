...
function deny(text,{allowActivation=false}={}){message.textContent=text;activationLink.hidden=!allowActivation;if(allowActivation){activationLink.href='../driver.html#activate='+encodeURIComponent(token);activationLink.textContent=t('driver.goActivation')}}
