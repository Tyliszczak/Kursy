...
async function start(){
  initI18n(document.body);globalThis.KURSY_T=t;if(!token){deny(t('driver.noToken'));return}
  ...
  globalThis.KURSY_DRIVER_CONTEXT=Object.freeze({companyId:status.company.id,driverId:status.driver.id,activationToken:token,deviceId:identity.deviceId,fingerprint:identity.fingerprint,dataApiUrl:licenseCloudApi.endpoint()});
