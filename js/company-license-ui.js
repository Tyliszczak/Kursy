...
function render(){
  ...
  const readonly=contactEditing?'':'readonly';
  const contactActions=contactEditing
    ?`<div class="actions"><button class="btn primary" type="submit">Zapisz zmiany</button><button class="btn" type="button" data-cancel-company-contact>Anuluj</button></div>`
    :`<div class="actions"><button class="btn" type="button" data-edit-company-contact>Edytuj dane</button></div>`;
