(()=>{
  ...
  style.textContent=`
    ...
    .stopCard .tableActions [data-remove-stop]{position:absolute;right:8px;top:50%;transform:translateY(-50%);z-index:10;pointer-events:auto;touch-action:manipulation}
  ...
  document.addEventListener('click',e=>{
    ...
    if(card){if(e.target.closest('[data-add-stop-after]'))return;const edit=card.querySelector('[data-edit-stop]');if(edit){stopHeader();e.preventDefault();e.stopImmediatePropagation();bypass=true;edit.click();bypass=false}}
  },true);
