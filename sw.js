const CACHE='kursy-v0.4.3';
const APP_ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./css/app.css','./js/app.js','./js/data.js','./js/api.js','./js/map-editor-bridge.js','./map-editor.html'];
