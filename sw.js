const CACHE='kursy-v0.6.0';
const APP_ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./css/app.css','./js/app-v2.js','./js/data.js','./js/api.js','./js/map-editor-bridge.js','./map-editor.html'];
